                    ...
                    <div className="md:col-span-4 px-3 flex-row">
                        <div className="flex flex-row md:flex-col-reverse grid md:grid-cols-6">
                            <div className="flex flex-row md:flex-col md:col-span-1 hidden md:block">
                                <div className="p-5 m-5 shadow-md"><Image src={data.productimageUrl} alt={product.name} width={70} height={50} layout="responsive" /></div>
                                <div className="p-5 m-5 shadow-md"><Image src={data.productimageUrl} alt={product.name} width={70} height={50} layout="responsive" /></div>
                                <div className="p-5 m-5 shadow-md"><Image src={data.productimageUrl} alt={product.name} width={70} height={50} layout="responsive" /></div>
                            </div>
                            <div className="flex flex-col col-span-2 mt-5 my-10">
                                <div className="p-10 shadow-md"><Image src={data.productimageUrl} alt={product.name} width={70} height={80} layout="responsive" /></div>
                            </div>
